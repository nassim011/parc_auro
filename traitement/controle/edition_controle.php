...
if (isset($_POST['num']) && isset($_POST['nom']) && isset($_POST['de']) && isset($_POST['dure']) && isset($_POST['obss']) && isset($_POST['mv'])){
    if (preg_match('#^[0-9]{2}-[0-9]{3}-[0-9]{1,}$#',$_POST['mv']) && $_POST['de']<$_POST['dure']){
        ...
        try{
            $pdo=inssertion($pdo,"UPDATE controle SET num_controle='$num' ,organisme='$nom',date_effet='$datef' ,duree='$datex',observations='$obss',matricule='$m' WHERE  num_controle='$numold'");
            echo "<div class='alert alert-success'>";
            echo "<strong>Success!</strong> Vous Avez Bien Modifier La controle : </div>";
        }
